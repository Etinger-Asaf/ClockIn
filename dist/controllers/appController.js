...
const clockIn = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { curYear, curMonth, curDay, namedDay, timeMilisecond, namedMonth } = (0,
      dates_1.dates)();
...
const clockOut = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const months =
        yearCollection === null || yearCollection === void 0
          ? void 0
          : yearCollection.months.filter((obj) => obj.month === curMonth);
      let day =
        months === null || months === void 0
          ? void 0
          : months[0].days.find((day) => day.number === curDay);
...
const monthSalary = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const totalDuration =
        durationSum === null || durationSum === void 0 ? void 0 : durationSum[0].totalDuration;
      const year = yield appModel_1.Year.findOne({ year: curYear });
      const month =
        year === null || year === void 0
          ? void 0
          : year.months.filter((obj) => obj.month === curMonth);
      const days =
        (_a = month === null || month === void 0 ? void 0 : month[0]) === null || _a === void 0
          ? void 0
          : _a.days.length;
      if (!totalDuration || !days)
        throw new baseError_1.default(500, `Days or Duration were missing`, false);
      const { salary, hours, minutes, transport, socialSecurity, pension, irs, health, neto } = (0,
      salary_1.default)(totalDuration, days);
      res.status(200).json({
        status: "success",
        body: {
